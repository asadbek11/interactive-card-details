const cardNumber = document.getElementById("number"),
  numberInp = document.getElementById("card_number"),

  cardName = document.getElementById("name"),
  nameInp = document.getElementById("card_name"),

  cardMonth = document.getElementById("month"),
  monthInp = document.getElementById("card_month"),

  cardYear =document.getElementById("year"),
  yearInp = document.getElementById("card_year"),

  cardCvc = document.getElementById("cvc"),
  cvcInp = document.getElementById("card_cvc"),
...
function handleSubmit(e){
  ...
  if(
    nameInp.value&& numberInp.value && monthInp.value && yearInp.value && cvcInp.value
  ){
